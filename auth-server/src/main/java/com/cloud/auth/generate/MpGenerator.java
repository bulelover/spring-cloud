...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setPassword("xiann");
        dsc.setUrl("jdbc:mysql://10.1.74.191:3306/test?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC");
...
//            @Override
//            public String outputFile(TableInfo tableInfo) {
//                return "classpath:/mapper/user/" + tableInfo.getEntityName() + ".xml";
//            }
//        });
//        cfg.setFileOutConfigList(focList);
//        mpg.setCfg(cfg);
